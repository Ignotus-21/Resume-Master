    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
      <Card className="w-full max-w-sm p-8">
        <div className="flex items-center gap-2 justify-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-[#202124]">New password</h1>
        </div>

        {!token ? (
          <div className="text-center">
            <p className="text-[#5f6368] text-sm mb-6">This reset link is missing its token. Request a new one.</p>
            <Link href="/forgot-password"><Button variant="secondary" className="w-full">Request a new link</Button></Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-[#5f6368] mb-1.5">New password</label>
              <input
                type="password"
                required
                minLength={8}
            ...
            <div>
              <label className="block text-sm font-medium text-[#5f6368] mb-1.5">Confirm password</label>
              <input
                type="password"
                required
                minLength={8}
